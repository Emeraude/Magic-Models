...
module.exports = function(orm, name, fields, options) {
  ...
  if (!orm[name] || erase) {
    ...
    orm[name].describe = function(options, cb) {
      require('./describe')(orm, orm[name], options, cb);
    }
  }
  ...
  if (options) {
    ...
    _.each(hooks, function(h, n) {
      if (options[n] !== undefined)
	orm[name].hooks[n] = options[n];
    });
  }
