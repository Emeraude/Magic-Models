...
module.exports.update = function(orm, model, params, callback) {
	...
	if (validation.length != 0)
	    ...
	    model.afterValidate(params, function(params) {
		model.beforeUpdate(params, function(params) {
		    model.beforeSave(params, function(params) {
			update(orm, model, params, function(e, r, i) {
